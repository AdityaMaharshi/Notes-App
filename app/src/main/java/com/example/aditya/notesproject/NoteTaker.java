...
class NoteTaker extends AppCompatActivity {
    ...
    private void actionDelete() {
        ...
        AlertDialog.Builder dialogDelete = new AlertDialog.Builder(this).setTitle("Delete Note")
                .setMessage("Delete the Note? You sure?")
